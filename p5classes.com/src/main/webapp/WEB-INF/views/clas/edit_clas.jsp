...
<body>
	...
	<%@include file="../static/header_menu.html"%>
		...
		<c:url var="updateClasUrl" value="/clas/updateClas" />
		<form:form method="POST" modelAttribute="clas" class="formStyle" action="${updateClasUrl}">
			<form:input type="hidden" path="clasId" id="clasId" />
			<table style="margin: 0 auto;">
				<tr><td colspan=3 class="formHeading">Edit Class Form</td></tr>
				<tr><td colspan=3>${ERROR_MSG} &nbsp;</td></tr>

				<tr>
					<td><spring:message code="label.clasId" />:</td>
					<td><form:input path="clasId" readOnly="readonly"/></td>
					<td><form:errors path="clasId" cssStyle="color: #ff0000;" /></td>
				</tr>
