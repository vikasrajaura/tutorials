...
<body>
	...
	<%@include file="../static/header_menu.html"%>
		...
		<c:url var="savePrivilegeUrl" value="/privilege/savePrivilege" />
		<form:form method="POST" modelAttribute="privilege" class="formStyle" action="${savePrivilegeUrl}" enctype="multipart/form-data">
			<form:input type="hidden" path="privId" id="privId" />
			<table style="margin: 0 auto;">
				<tr><td colspan=3 class="formHeading">Privilege Registration Form</td></tr>
